<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ request()->is('barang', 'barangmasuk', 'barangkeluar') ? 'active' : 'none' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ request()->is('barangmasuk') ? 'active' : 'none' }}">
                        <a class="nav-link" href="{{url('/barangmasuk')}}">Barang Masuk</a>
                    </li>
                    <li class="{{ request()->is('barangkeluar') ? 'active' : 'none' }}">
